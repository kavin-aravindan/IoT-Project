...
const int trigPin1 = 19;  // Trigger pin for sensor 1
const int echoPin1 = 36;  // Echo pin for sensor 1

const int trigPin2 = 21;  // Trigger pin for sensor 2
const int echoPin2 = 39;  // Echo pin for sensor 2

const int trigPin3 = 33;  // Trigger pin for sensor 3
const int echoPin3 = 32;  // Echo pin for sensor 3

const int trigPin4 = 27;  // Trigger pin for sensor 4
const int echoPin4 = 25;  // Echo pin for sensor 4
...
const int led_green_1 = 26;
const int led_green_2 = 23;
const int led_green_3 = 22;
...
void loop() {
  ...
  Serial.println();
  // END DEBUG PRINTS
  write_to_om2m(type, count_arr, arr2, "Junction-3/Data");
